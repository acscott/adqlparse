/* 
 * Token name start with an uppercase letter
 * Parser rule names start with lowercase letter
 * 
...
options { language=Python3; }
  ...
  concatenation : character_factor concatenation_operator character_factor;
  ...
  regular_identifier :
      simple_Latin_letter ( ( digit | simple_Latin_letter | underscore )* );
  ...
  sort_key : column_name | unsigned_integer ;
   /* For information, the use of unsigned_integer in sort_keyis a deprecated feature of SQL92 */
